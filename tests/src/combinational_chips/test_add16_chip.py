...
def test_add16_chip():
    ...
    # ) == Bits16.from_string("1111111111111111")
    print("Adding")
    print(Bits16.from_string("0011110011000011").as_string())
    print(Bits16.from_string("0000111111110000").as_string())
    print(
        add16_chip(
            Bits16.from_string("0011110011000011"),
            Bits16.from_string("0000111111110000"),
        ).as_string()
    )
    print(Bits16.from_string("0100110010110011").as_string())
